...
public class CreationTool extends AbstractTool {
    ...
    public void mouseReleased(MouseEvent evt) {
        if (createdFigure != null) {
            handleCreatedFigureRelease(evt);
        } else {
    ...
    private void handleCreatedFigureRelease(MouseEvent evt) {
        Rectangle2D.Double bounds = createdFigure.getBounds();
        if (bounds.width == 0 && bounds.height == 0) {
            removeCreatedFigureAndMaybeFinish();
            return;
        }

        maybeEnforceMinimalSize(evt, bounds);
        ...
        postCreationFireUndo(addedFigure, addedDrawing);
    ...
    private void removeCreatedFigureAndMaybeFinish() {
    ...
    private void maybeEnforceMinimalSize(MouseEvent evt, Rectangle2D.Double bounds) {
    ...
    private void postCreationFireUndo(final Figure addedFigure, final Drawing addedDrawing) {
